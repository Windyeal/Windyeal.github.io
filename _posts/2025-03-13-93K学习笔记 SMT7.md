...
|/etc/opt/hp93000/soc_common/model <br> /etc/opt/hp93000/soc_common/org <br> /etc/opt/hp93000/soc_common/passwd <br> /etc/opt/hp93000/soc_common/ppu_alarms<br>|这些文件可以在不同版本之间共享。对于列出的每个文件，对应的版本目录中都会有一个指向公共配置文件的链接|
...
|/var/opt/hp93000/soc_common/tracecal <br> /var/opt/hp93000/soc_common/tmp/var/opt/hp93000/soc_common/diagnostic|数据存储目录，任何版本的SmarTest软件生成的数据文件都将存储在这些公共目录中。对于列出的每个目录，对应版本特定目录中的链接指向公共目录|
